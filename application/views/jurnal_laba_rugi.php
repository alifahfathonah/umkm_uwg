  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <table class="table w-100 table-bordered table-hover" id="jurnal_laba_rugi">
              <thead>
                <tr>
                  <th>No</th>
                  <th>Tanggal</th>
...
<script>
  var laporanUrl = '<?php echo site_url('jurnal_laba_rugi/read') ?>';
</script>
<script src="<?php echo base_url('assets/js/unminify/jurnal_laba_rugi.js') ?>"></script>
</body>
</html>
